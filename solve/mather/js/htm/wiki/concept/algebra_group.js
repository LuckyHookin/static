...
detail('群的例子 Group Examples',Table([['名称','记法','定义','性质']],[
	['加法群'],
	['乘法群'],
	['置换群','S_n',''],

	['加法偏移','',khrA(['集合：ℝ','运算:a★b= a+b-C 其中C是常数','单位元：C','逆元：2C-a'])],
	['乘法缩放','',khrA(['集合：ℝ','运算:a★b= kab 其中常数k≠0','单位元：1\\/k','逆元：1\\/{k^2a}'])],
	['加乘缩放','',khrA(['集合：ℝ-\\{-1\\/k\\}','运算:a★b= a+b+kab 其中k是常数','单位元：0','逆元：-a\\/{1+ka}'])],
